 ...
 * @author daniele
 */
public class LogManFinal_1 extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public LogManFinal_1() {
        initComponents();
    }
...
LogEmpFinal a= new LogEmpFinal();
        a.setVisible(true);
        a.setDefaultCloseOperation(LogEmpFinal.DISPOSE_ON_CLOSE);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LogManFinal().setVisible(true);
            }
        });
    }
