...
public class Administrator extends Person {
	...
	private AdminDB admindatabase = new AdminDB();
	 ...
	 * Add to employee db.
	 */
	public void createEmployee() throws IllegalArgumentException {
		...
		if(this.getLoggedIn()) {
			...
			throw new IllegalArgumentException("You are not logged in as Administrator");
		}
